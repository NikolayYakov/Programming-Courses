...
export async function register(email,username,password,repeatPassword,gender){
    let result = await post(settings.host+'/users/register',{email,username,password,repeatPassword,gender})
    setUserInfo(result);
    return result;
